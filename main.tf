...
resource "abbey_grant_kit" "null_grant" {
    ...
    steps = [
      {
        reviewers = {
          ...
          one_of = ["kdamaroli@gmail.com"] # Use your own Abbey account [1].
        }
      }
    ]
  }
  ...
  output = {
    ...
    location = "github://kdamaroli/kevins3/access.tf" # Use your own organization and repo.
    append = <<-EOT
...
resource "abbey_identity" "user_1" {
  ...
  linked = jsonencode({
    abbey = [
      {
        type  = "AuthId"
        value = "kdamaroli@gmail.com" # Use your own Abbey account.
      }
    ]
  })
}
